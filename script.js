...
const trickLibrary = [
  ...
  { id: "double-cork", name: "Double Cork", aliases: ["Dub Cork"], modes: ["ground", "gtramp"], categories: ["twisting"], difficulty: "master" },
  { id: "cheat-900", name: "Cheat 900", aliases: ["Cheat 9"], modes: ["ground"], categories: ["creative", "twisting"], difficulty: "master" },
  { id: "triple-full", name: "Triple Full", aliases: [], modes: ["gtramp"], categories: ["twisting"], difficulty: "master" },
  { id: "arabian-double", name: "Arabian Double", aliases: [], modes: ["ground", "gtramp"], categories: ["flipping"], difficulty: "master" },
  { id: "full-in-full-out", name: "Full-In Full-Out", aliases: [], modes: ["gtramp"], categories: ["twisting", "flipping"], difficulty: "master" },
  { id: "rudy-out", name: "Rudy Out", aliases: [], modes: ["gtramp"], categories: ["twisting", "flipping"], difficulty: "master" },
  { id: "miller", name: "Miller", aliases: [], modes: ["gtramp"], categories: ["twisting", "flipping"], difficulty: "master" }
];
