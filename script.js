...
const trickLibrary = [
  ...
  { id: "23-in-flips", name: "23 in flips", aliases: [], modes: ["gtramp"], categories: ["flipping"], difficulty: "hard" },
  { id: "quint-cat-twist", name: "quint cat twist", aliases: [], modes: ["gtramp"], categories: ["twisting", "creative"], difficulty: "hard" },
  { id: "333-in-fulls", name: "333 in fulls", aliases: [], modes: ["gtramp"], categories: ["twisting"], difficulty: "hard" },
  { id: "dub-cork", name: "dub cork", aliases: ["Double Cork", "Dub Cork"], modes: ["ground", "gtramp"], categories: ["twisting"], difficulty: "hard" },
  { id: "randy-quad-full", name: "randy quad full", aliases: [], modes: ["gtramp"], categories: ["twisting"], difficulty: "hard" },
  { id: "sanding-22-in-codies", name: "sanding 22 in codies", aliases: [], modes: ["gtramp"], categories: ["creative", "flipping"], difficulty: "hard" },
  { id: "ballout-half-in-dub", name: "ballout half in dub", aliases: [], modes: ["gtramp"], categories: ["creative", "flipping"], difficulty: "hard" },
  { id: "44-in-cat-twists", name: "44 in cat twists", aliases: [], modes: ["gtramp"], categories: ["twisting", "creative"], difficulty: "hard" },
  { id: "rudy-in", name: "rudy in", aliases: [], modes: ["gtramp"], categories: ["twisting", "flipping"], difficulty: "hard" },
  { id: "dub-full-in", name: "dub full in", aliases: [], modes: ["gtramp"], categories: ["twisting", "flipping"], difficulty: "hard" },
  { id: "full-full-landed", name: "full full landed", aliases: [], modes: ["gtramp"], categories: ["twisting"], difficulty: "hard" },
  { id: "trip-front-landed", name: "trip front landed", aliases: [], modes: ["gtramp"], categories: ["flipping"], difficulty: "hard" },
  ...
  { id: "j-step-dub-gainer", name: "j step dub gainer", aliases: [], modes: ["gtramp"], categories: ["creative", "flipping"], difficulty: "hard" },
  { id: "dub-frisbee", name: "dub frisbee", aliases: [], modes: ["gtramp"], categories: ["creative", "flipping"], difficulty: "hard" },
  { id: "knee-trip-front", name: "knee trip front", aliases: [], modes: ["gtramp"], categories: ["flipping"], difficulty: "hard" },
  { id: "quad-full", name: "quad full", aliases: [], modes: ["gtramp"], categories: ["twisting"], difficulty: "hard" },
  { id: "tramp-kong-gainer", name: "tramp kong gainer", aliases: [], modes: ["gtramp"], categories: ["flipping"], difficulty: "hard" },
  { id: "a-twist-in", name: "a twist in", aliases: [], modes: ["ground"], categories: ["twisting"], difficulty: "hard" },
  { id: "123-in-kabooms", name: "123 in kabooms", aliases: [], modes: ["gtramp"], categories: ["creative", "flipping"], difficulty: "hard" },
  { id: "fliffus-x-dub-back", name: "fliffus x dub back", aliases: [], modes: ["gtramp"], categories: ["creative", "flipping"], difficulty: "hard" },
  { id: "dub-10", name: "dub 10", aliases: [], modes: ["gtramp"], categories: ["twisting"], difficulty: "hard" },
  { id: "full-1-5-x-dub-front-x-ballout-half-in-x-cody-full", name: "full 1.5 x dub front x ballout half in x cody full", aliases: [], modes: ["gtramp"], categories: ["twisting", "flipping"], difficulty: "hard" },
  ...
  { id: "dub-back-x-quad-full", name: "dub back x quad full", aliases: [], modes: ["gtramp"], categories: ["twisting", "flipping"], difficulty: "hard" },
  { id: "trip-back-x-dub-cody", name: "trip back x dub cody", aliases: [], modes: ["gtramp"], categories: ["creative", "flipping"], difficulty: "hard" },
  { id: "dub-lay-x-full-in-x-trip-full", name: "dub lay x full in x trip full", aliases: [], modes: ["gtramp"], categories: ["twisting", "flipping"], difficulty: "hard" },
  { id: "brenna-plus", name: "brenna+", aliases: ["brenna plus"], modes: ["gtramp"], categories: ["creative"], difficulty: "hard" },
  { id: "dub-snapu", name: "dub snapu", aliases: [], modes: ["gtramp"], categories: ["creative", "flipping"], difficulty: "hard" },
