...
const trickLibrary = [
  ...
  { id: "cody", name: "Cody", aliases: ["Cody Out"], modes: ["ground", "gtramp"], categories: ["creative", "flipping"], difficulty: "medium" },
  { id: "seat-drop-back", name: "Seat Drop Backflip", aliases: ["Seat Drop Back Out"], modes: ["ground", "gtramp"], categories: ["creative", "flipping"], difficulty: "medium" },
  { id: "front-drop-back", name: "Front Drop Back Out", aliases: ["Stomach Drop Back Out"], modes: ["ground", "gtramp"], categories: ["creative", "flipping"], difficulty: "medium" },
  { id: "back-drop-back", name: "Back Drop Back Out", aliases: [], modes: ["ground", "gtramp"], categories: ["creative", "flipping"], difficulty: "medium" },
  { id: "crash-dive", name: "Crash Dive", aliases: [], modes: ["ground", "gtramp"], categories: ["creative", "flipping"], difficulty: "medium" },
